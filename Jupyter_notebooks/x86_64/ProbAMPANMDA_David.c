...
#define nrn_init _nrn_init__ProbAMPANMDA_David
#define _nrn_initial _nrn_initial__ProbAMPANMDA_David
#define nrn_cur _nrn_cur__ProbAMPANMDA_David
#define _nrn_current _nrn_current__ProbAMPANMDA_David
#define nrn_jacob _nrn_jacob__ProbAMPANMDA_David
#define nrn_state _nrn_state__ProbAMPANMDA_David
#define _net_receive _net_receive__ProbAMPANMDA_David 
#define setRNG setRNG__ProbAMPANMDA_David 
#define state state__ProbAMPANMDA_David 
...
#define e _p[4]
#define gmax_AMPA _p[5]
#define gmax_NMDA _p[6]
#define Use _p[7]
#define Dep _p[8]
#define Fac _p[9]
#define u0 _p[10]
...
#define erand erand_ProbAMPANMDA_David
 extern double erand( );
 /* declare global and static user variables */
#define mggate mggate_ProbAMPANMDA_David
 double mggate = 0;
#define mg mg_ProbAMPANMDA_David
 double mg = 1;
 ...
 "mg_ProbAMPANMDA_David", &mg_ProbAMPANMDA_David,
 "mggate_ProbAMPANMDA_David", &mggate_ProbAMPANMDA_David,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_David /Users/gili/Desktop/NEURON_tutorial-master/Jupyter_notebooks/mods/ProbAMPANMDA_David.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 97 in file ProbAMPANMDA_David.mod:\n    \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gili/Desktop/NEURON_tutorial-master/Jupyter_notebooks/mods/ProbAMPANMDA_David.mod";
static const char* nmodl_file_text = 
  ...
  "David: added seperate gmax for NMDA and AMPA (gmax_NMDA, gmax_AMPA accessible in NERUON python)\n"
  "\n"
  "ENDCOMMENT\n"
  "\n"
  "\n"
  "NEURON {\n"
  "    POINT_PROCESS ProbAMPANMDA_David\n"
  "    RANGE tau_r_AMPA, tau_d_AMPA, tau_r_NMDA, tau_d_NMDA\n"
  "    RANGE Use, u, Dep, Fac, u0, weight_NMDA\n"
  "    RANGE i, i_AMPA, i_NMDA, g_AMPA, g_NMDA, e, gmax_AMPA, gmax_NMDA\n"
  ...
  "    g_AMPA = gmax_AMPA * (B_AMPA - A_AMPA)                         :compute time varying conductance based on state variables B_AMPA and A_AMPA\n"
  "    g_NMDA = gmax_NMDA * (B_NMDA - A_NMDA) * mggate                :compute time varying conductance based on state variables B_NMDA and A_NMDA and mggate kinetics\n"
  "    i_AMPA = g_AMPA * (v - e)                                      :compute the AMPA current based on the conductance, membrane potential, and AMPA reversal\n"
  "    i_NMDA = g_NMDA * (v - e)                                      :compute the NMDA current based on the conductance, membrane potential, and NMDA reversal\n"
  "    i = i_AMPA + i_NMDA\n"
  "}\n"
  "\n"
  "DERIVATIVE state {\n"
